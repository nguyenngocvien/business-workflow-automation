...
CREATE INDEX idx_process_user_username ON process_user(username);
...
CREATE TABLE process_group (
    ...
    CONSTRAINT fk_group_parent FOREIGN KEY (parent_group_id) REFERENCES process_group(id)
);

CREATE INDEX idx_process_group_parent ON process_group(parent_group_id);

CREATE INDEX idx_process_group_path ON process_group(path);

CREATE INDEX idx_process_group_level ON process_group(level);
...
CREATE TABLE process_user_group (
    ...
    CONSTRAINT fk_user_group_user FOREIGN KEY (user_id) REFERENCES process_user(id),
    CONSTRAINT fk_user_group_group FOREIGN KEY (group_id) REFERENCES process_group(id),
    CONSTRAINT uq_user_group UNIQUE (user_id, group_id)
);

CREATE INDEX idx_process_user_group_user ON process_user_group(user_id);

CREATE INDEX idx_process_user_group_group ON process_user_group(group_id);